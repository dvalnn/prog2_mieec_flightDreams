...
/* encontra um determinado voo através do codigo 
*  parametro g - apontador para o grafo em que se pretende procurar
*  parametro codigo - apontador para o codigo de voo que se pretende procurar no grafo
*  retorna um apontador para um nó de origem desse voo, em caso de erro retorna NULL 
*  retorna por referência através do argumento ‘aresta_pos‘ a posição da respetiva aresta no vetores de arestas do nó retornado (nó origem do voo)
*/
